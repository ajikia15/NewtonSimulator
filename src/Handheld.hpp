...
public:
    ...
    void gameGuide()
    {
        ...
        mvwprintw(gwin, 6, 2, "Catch Apples! Indicated as");
        wattron(gwin, COLOR_PAIR(APPLE + 1));
        mvwprintw(gwin, 6, 28, "'O'");
        wattroff(gwin, COLOR_PAIR(APPLE + 1));
        mvwprintw(gwin, 8, 2, "Avoid Rocks! Indicated as '*'");
        mvwprintw(gwin, 8, 2, "Catch Health Aids! Indicated as ");
        wattron(gwin, COLOR_PAIR(HEALTH + 1));
        mvwprintw(gwin, 7, 34, "'+'");
        wattroff(gwin, COLOR_PAIR(HEALTH + 1));
    ...
    void ouch()
    {
        mvwprintw(mwin, mh - 5, mw / 2 - 5, "OUCH!");
    }
};
